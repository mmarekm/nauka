...
var lektury = ["Opowieści z Narnii: Lew, czarownica i stara szafa","Opowieści z Narnii: Książę Kaspian"];
var dni = ["6 maja 2024 r.","7 maja 2024 r.","9 maja 2024 r.","10 maja 2024 r.","13 maja 2024 r.","13 maja 2024 r.","14 maja 2024 r.","15 maja 2024 r.","16 maja 2024 r.","17 maja 2024 r."];
...
var dzien = [dni[4],dni[3],dni[2],dni[1],dni[0],"<b>data</b>"];
...
var lekturaUla = [lektury[1],lektury[1],lektury[1],lektury[1],lektury[1],"<b>lektura Ula</b>"];
var lekturaBasia = [lektury[1],lektury[1],lektury[1],lektury[0],lektury[0],"<b>lektura Basia</b>"];
...
var informatykaUla = [informatyka[5],informatyka[4],informatyka[0] + ";<br/><s>" + informatyka[3]  + '</s>',informatyka[2],informatyka[1],"<b>inform Ula</b>"];
var informatykaBasia =[informatyka[5],informatyka[4],informatyka[0] + ";<br/><s>" + informatyka[3]  + '</s>',informatyka[0] + ";<br/>" + informatyka[2],informatyka[1],"<b>inform Basia</b>"];
