...
var dzien = [dni[12],dni[11],dni[10],dni[9],dni[8],dni[6],dni[5] + ' oraz ' + dni[7],dni[4],dni[3],dni[2],dni[1],dni[0],"<b>data</b>"];
var religiaUla = [religiaV[11],religiaV[10],religiaV[9],religiaV[8],religiaV[7],religiaV[6],religiaV[5],religiaV[4],religiaV[3],religiaV[2],religiaV[1],religiaV[0],"<b>religia Ula</b>"];
var religiaBasia = [religiaIII[11],religiaIII[10],religiaIII[9],religiaIII[8],religiaIII[7],religiaIII[6],religiaIII[5],religiaIII[4],religiaIII[3],religiaIII[2],religiaIII[1],religiaIII[0],"<b>religia Basia</b>"];
var matematykaUla = ["",zadMatUla[2],"Oblicz: 0.25 + 0.01 =<br/>0.3 + 0.001=<br/>1.1 + 0.11 =<br/>10.01 + 1.1 =<br/>8.27 + 1.73=","Zamień na ułamek dziesiętny: <sup>1</sup>/<sub>5</sub> <sup>3</sup>/<sub>4</sub> <sup>5</sup>/<sub>8</sub>","",zadMatUla[1],"nauka NWD i NWW na przykładach: NWD(36,48), NWD(56, 84), NWW(8,28), NWW(12,16)","Rozłóż następujące liczby na czynniki pierwsze: 198, 315, 486, 768","Rozłóż następujące liczby na czynniki pierwsze: 375, 567, 8192",zadMatUla[0],"Które liczby są złożone: 3, 9, 13, 22, 31, 41, 45, 69","Które liczby są pierwsze: 2, 7, 15, 23, 33, 49, 51, 61?","<b>matem Ula</b>"];
var matematykaBasia = ["",zadMatBasia[2],"Oblicz: 77 - 56 =<br/>92 - 9 =<br/>13 + 39 =<br/>91 - 19 =<br/>66 + 55=","<br/>15 g + 45 g = ... dag<br/>23 dag - 150g = ... g<br/>650 g + 35 dag = ... kg","",zadMatBasia[1],"Oblicz: {[(37 + 43) : (71 - 63)] x [(44 + 37) : (102 - 93)]} + 3 x 6","Oblicz:<br/>2x4 + 3x3 + 8x8<br/>--------------------- =<br/>7x9 - 6x8 - 54:9","<br/>L - IX x IV<br/>C - X x VIII<br/>LX + XL<br/>V x VIII + VII x IX<br/><br/>Wzdłuż 1 cm można ułożyć 1 g ziarenek. Na jakiej odległości należy ułożyć ziarenka, by ważyły pół kg?",zadMatBasia[0],"Oblicz: 9x5, 7x7, 4x6, 3x9, 2x7, 9x8, 5x7, 6x7 ","Oblicz: 6x5, 4x7, 3x8, 2x9, 7x5, 8x4, 9x9, 4x4","<b>matem Basia</b>"];
var lekturaUla = [lektury[2],lektury[2],lektury[2],lektury[2],lektury[2],lektury[2],lektury[2],lektury[2],lektury[2],lektury[1],lektury[1],lektury[1],"<b>lektura Ula</b>"];
var lekturaBasia = [lektury[1],lektury[1],lektury[1],lektury[1],lektury[1],lektury[1],lektury[1],lektury[1],lektury[1],lektury[1],lektury[0],lektury[0],"<b>lektura Basia</b>"];
var polskiUla = ["Dyktando: " + ortografia[3],zadPolUla[2],"Dyktando: " + ortografia[2],"",zadPolUla[1],"",zadPolUla[0],"","Dyktando: " + ortografia[1],"Dyktando: " + ortografia[0],"","","<b>gram pol Ula</b>"];
var polskiBasia = ["Dyktando: " + ortografia[3],zadPolBasia[0],"Dyktando: " + ortografia[2],"Zapoznaj się z trzema legendami polskimi","Napisz krótkie opowiadanie na temat: Jak mogło wyglądać spotkanie Aslana z faunem Panem Tumnusem na Latarnianym Pustkowiu.","","napisz ze słyszenia: tchórz, również, jaskółka, wahać, borsuk, kłótnia, mrówka, jarzębina, jeżyna, rzodkiewka","","Dyktando: " + ortografia[1],"Dyktando: " + ortografia[0],"","","<b>gram pol Basia</b>"];
var slowkaAngUla = [slowka[8],slowka[7],slowka[6],slowka[5],slowka[4],"",slowka[3],slowka[2],"","",slowka[1],slowka[0],"<b>słówka Ula</b>"];
